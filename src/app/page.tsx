  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="text-center px-6 pt-20 md:pt-28 pb-8">
        <div className="inline-block bg-[#e53e3e]/10 border border-[#e53e3e]/20 rounded-full px-4 py-1.5 text-[11px] text-[#e53e3e] tracking-[2px] mb-6 font-medium">FREE DURING BETA — TRY EVERYTHING FREE</div>
      ...
      <section id="pricing" className="max-w-[900px] mx-auto px-6 py-20 border-t border-white/[0.04] text-center">
        ...
        <div className="inline-block bg-[#e53e3e]/10 border border-[#e53e3e]/20 rounded-full px-4 py-1.5 text-[11px] text-[#e53e3e] tracking-[2px] mb-12 font-medium">FREE DURING BETA — TRY EVERYTHING FREE</div>
