  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="pricing" className="max-w-[900px] mx-auto px-6 py-20 border-t border-white/[0.04] text-center">
        ...
        <div className="inline-block bg-[#e53e3e]/10 border border-[#e53e3e]/20 rounded-full px-4 py-1.5 text-[11px] text-[#e53e3e] tracking-[2px] mb-12 font-medium">UP AND RUNNING IN UNDER AN HOUR</div>
